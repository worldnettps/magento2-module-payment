...
class Data extends AbstractHelper
{
    ...
    {
        return $this->_getUrl('worldnettps/directpost_payment/redirect', $params);
    }
    ...
    {
        return $this->_getUrl('checkout/onepage/failure', $params);
    }
    ...
    public function getTransactionMessage(
        ...
        if ($lastTransactionId !== null) {
            $message[] = __('WorldNetTPS Transaction ID %1.', $lastTransactionId);
        }
    ...
    {
        switch ($requestType) {
            case WorldnetTPS::REQUEST_TYPE_AUTH_ONLY:
                return __('authorize');
            case WorldnetTPS::REQUEST_TYPE_AUTH_CAPTURE:
                return __('authorize and capture');
            case WorldnetTPS::REQUEST_TYPE_PRIOR_AUTH_CAPTURE:
                return __('capture');
            case WorldnetTPS::REQUEST_TYPE_CREDIT:
                return __('refund');
            case WorldnetTPS::REQUEST_TYPE_VOID:
                return __('void');
            default:
                return false;
        }
    ...
    public function getRelayUrl($storeId = null)
    {
        ...
        return $baseUrl . 'worldnettps/directpost_payment/response';
    }
