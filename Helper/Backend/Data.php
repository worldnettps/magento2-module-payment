 ...
 */
namespace WorldnetTPS\Payment\Helper\Backend;

use WorldnetTPS\Payment\Helper\Data as FrontendDataHelper;
...
/**
 * WorldnetTPS TPS Backend Data Helper
 */
class Data extends FrontendDataHelper
{
    ...
    {
        return $this->_getUrl('adminhtml/worldnettps_directpost_payment/place', []);
    }
    ...
    {
        return $this->_getUrl('adminhtml/worldnettps_directpost_payment/redirect', $params);
    }
    ...
    public function getRelayUrl($storeId = null)
    {
        ...
        return $baseUrl . 'worldnettps/directpost_payment/backendResponse';
    }
}
