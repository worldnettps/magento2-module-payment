 ...
 */
class XmlSubscriptionUpdResponse extends DataObject
{
    ...
    public function initXmlSubscriptionUpdResponse($responseXml)
    {
        ...
        try
        {
            ...
            else if (strpos($responseXml, "UPDATESUBSCRIPTIONRESPONSE") !== false)
            {
                $responseNodes = $this->doc->getElementsByTagName("UPDATESUBSCRIPTIONRESPONSE");
