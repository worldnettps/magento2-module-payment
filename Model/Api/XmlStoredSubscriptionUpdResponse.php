 ...
 */
class XmlStoredSubscriptionUpdResponse extends DataObject
{
    ...
    public function initXmlStoredSubscriptionUpdResponse($responseXml)
    {
        ...
        try
        {
            ...
            else if (strpos($responseXml, "UPDATESTOREDSUBSCRIPTIONRESPONSE") !== false)
            {
                $responseNodes = $this->doc->getElementsByTagName("UPDATESTOREDSUBSCRIPTIONRESPONSE");
