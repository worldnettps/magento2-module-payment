 ...
 */
class XmlSecureCardRegResponse extends DataObject
{
    ...
    public function initXmlSecureCardRegResponse($responseXml)
    {
        ...
        try
        {
            ...
            else if (strpos($responseXml, "SECURECARDREGISTRATIONRESPONSE") !== false)
            {
                $responseNodes = $this->doc->getElementsByTagName("SECURECARDREGISTRATIONRESPONSE");
