 ...
 */
class XmlStoredSubscriptionDelResponse extends DataObject
{
    ...
    public function initXmlStoredSubscriptionDelResponse($responseXml)
    {
        ...
        try
        {
            ...
            else if (strpos($responseXml, "DELETESTOREDSUBSCRIPTIONRESPONSE") !== false)
            {
                $responseNodes = $this->doc->getElementsByTagName("DELETESTOREDSUBSCRIPTIONRESPONSE");
