 ...
 */
class XmlPreAuthCompletionResponse extends DataObject
{
    ...
    public function initXmlPreAuthCompletionResponse($responseXml)
    {
        ...
        try
        {
            ...
            else if (strpos($responseXml, "PREAUTHCOMPLETIONRESPONSE") !== false)
            {
                $responseNodes = $this->doc->getElementsByTagName("PREAUTHCOMPLETIONRESPONSE");
