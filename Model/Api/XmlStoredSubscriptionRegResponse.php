 ...
 */
class XmlStoredSubscriptionRegResponse extends DataObject
{
    ...
    public function initXmlStoredSubscriptionRegResponse($responseXml)
    {
        ...
        try
        {
            ...
            else if (strpos($responseXml, "ADDSTOREDSUBSCRIPTIONRESPONSE") !== false)
            {
                $responseNodes = $this->doc->getElementsByTagName("ADDSTOREDSUBSCRIPTIONRESPONSE");
