...
/**
 * WorldnetTPS TPS DirectPost payment method model.
 * @SuppressWarnings(PHPMD.TooManyFields)
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects)
 * @SuppressWarnings(PHPMD.ExcessiveClassComplexity)
 */
class Directpost extends \WorldnetTPS\Payment\Model\WorldnetTPS implements TransparentInterface, ConfigInterface
{
    const METHOD_CODE = 'worldnettps_directpost';
    ...
    /**
     * @var \WorldnetTPS\Payment\Model\Directpost\Response
     */
    protected $response;
    ...
    public function __construct(
        ...
        \WorldnetTPS\Payment\Model\Directpost\Request\Factory $requestFactory,
        \WorldnetTPS\Payment\Model\Directpost\Response\Factory $responseFactory,
     ...
     * @return void
     */
    public function setDataHelper(\WorldnetTPS\Payment\Helper\Data $dataHelper)
    {
     ...
     *
     * @param \WorldnetTPS\Payment\Model\Directpost\Response $result
    ...
    /**
     * Return URL on which WorldnetTPS TPS server will return payment result data in hidden request.
     *
     * @param int $storeId
     * @return string
     */
     ...
     * Return response.
     *
     * @return \WorldnetTPS\Payment\Model\Directpost\Response
     */
     ...
     * @return \WorldnetTPS\Payment\Model\Directpost\Request
     */
    ...
    /**
     * Operate with order using data from $_POST which came from WorldNetTPS by Relay URL.
     *
     * @param array $responseData data from WorldnetTPS TPS from $_POST
     * @return void
    ...
    /**
     * Fill payment with credit card data from response from WorldnetTPS TPS.
     *
     * @param \Magento\Framework\DataObject $payment
     * @return void
     */
    ...
    /**
     * Check response code came from WorldnetTPS TPS.
     *
     * @return true in case of Approved response
     * @throws \Magento\Framework\Exception\LocalizedException In case of Declined or Error response from WorldnetTPS TPS
     */
    ...
    /**
     * Check transaction id came from WorldnetTPS TPS
     *
    ...
    /**
     * Operate with order using information from WorldnetTPS TPS.
    ...
    protected function addStatusComment(\Magento\Sales\Model\Order\Payment $payment)
    {
        try {
            ...
            $data = (array)$this->transactionService->getTransactionDetails($this, $transactionId);
    ...
    {
        $responseXmlDocument = (array) $this->transactionService->getTransactionDetails($this, $transactionId);
